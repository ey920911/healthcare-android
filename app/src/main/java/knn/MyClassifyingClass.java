...
//            Log.d("filepath",filePath);
  ...
  public boolean setAccTrainingClassifierFromFile(
  ...
  public boolean setGyroTrainingClassifierFromFile(
  ...
  public double[] getFeatures() {
    ...
    for (int i = 0; i < arrLength; i++) doubleArrXSubY[i] =
      doubleArrayAccX[i] - doubleArrayAccY[i]; //X-Y array

    Double[] doubleArrYSubZ = new Double[arrLength];

    for (int i = 0; i < arrLength; i++) doubleArrYSubZ[i] =
      doubleArrayAccY[i] - doubleArrayAccZ[i]; //Y-Z array

    Double[] doubleArrZSubX = new Double[arrLength];

    for (int i = 0; i < arrLength; i++) doubleArrZSubX[i] =
      doubleArrayAccZ[i] - doubleArrayAccX[i]; //Z-X array
